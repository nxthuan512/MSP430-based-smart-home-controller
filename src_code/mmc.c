...
void mmcReadSector(volatile unsigned long sdcard_address, unsigned char *pBuffer)
{
	sdcard_address *= 512;
	mmcReadBlock(sdcard_address, 512, pBuffer);
}

// read a size Byte big block beginning at the address.
char mmcReadBlock(volatile unsigned long address, const unsigned long count, unsigned char *pBuffer)
{
...
void mmcWriteSector(volatile unsigned long sdcard_address, unsigned char *pBuffer)
{
	sdcard_address *= 512;
	mmcWriteBlock(sdcard_address, 512, pBuffer);
}

//char mmcWriteBlock (const unsigned long address)
char mmcWriteBlock (volatile unsigned long address, const unsigned long count, unsigned char *pBuffer)
{
...
// send command to MMC
void mmcSendCmd (const char cmd, volatile unsigned long data, const char crc)
{
